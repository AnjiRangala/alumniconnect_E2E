  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        onNavigate('student-dashboard', { replace: true })
      } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-600 to-blue-800 flex items-center justify-center px-4">
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-8">
        ...
        <p className="text-gray-600 text-center mb-6">Access your AlumniConnect student account</p>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 text-white py-2 rounded-lg font-semibold hover:bg-blue-700 disabled:bg-blue-400 transition mt-6"
          >
